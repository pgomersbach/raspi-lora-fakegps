...
#define ADR_MODE 0 //Adaptive Data Rate: 1 = on, 0 = off
#define SF DR_SF7
#define START_LON 5.17917894
#define START_LAT 52.22981659
#define START_ALT 5
#define LAT_MOVE 10
#define LON_MOVE 10
...
// alocate send buffer
static uint8_t buffer[] = "00000000000";
static uint8_t cursor = 0;

int32_t lat = START_LAT * 10000;
int32_t lon = START_LON * 10000;
int32_t alt = START_ALT * 100;

static uint8_t mydata[] = "aa bb";
...
void do_send(osjob_t* j) {
    ...
    lat=lat+LAT_MOVE;
    lon=lon+LON_MOVE;
    // fill sendbuffer using cayenne gps format
    buffer[0] = 0; 
    buffer[1] = 136; 
    buffer[2] = lat >> 16; 
    buffer[3] = lat >> 8; 
